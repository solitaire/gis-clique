...
\begin{itemize}
 ...
 \item tests - pliki dla testów weryfikujących poprawność implementacji:
 	\begin{itemize}
 		\item correctness - pliki z grafami wykorzystanymi do weryfikacji poprawności algorytmu,
 		\item performance - pliki z grafami wykorzystanymi podczas analizy czasów wykonania algorytmu i jego poprawności,
 	\end{itemize}
...
\begin{enumerate}
 \item Skompilować kod Javy. W tym celu wystarczy uruchomić skrypt \texttt{java-workspace/build.sh}.
 \item Przygotować pliki wejściowe.
 \item Uruchomić program jednym z możliwych sposobów:
 \begin{itemize}
 	\item Ręczne uruchomienie. Należy wykonać następujące polecenie: \\
