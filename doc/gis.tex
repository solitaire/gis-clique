...
\begin{itemize}
 \item \texttt{java-workspace} - implementacja algorytmu będącego przedmiotem projektu,
...
\begin{enumerate}
 ...
 \begin{itemize}
 	\item Ręczne uruchomienie. W katalogu \texttt{java-workspace} należy wykonać następujące polecenie: \\
